...
class Game:
    ...
    def __init__(self, guess, previousGuesses, highscores, difficulty, gameMessage):
        self.guess = guess
    ...
    def take_turn(self):
        ...
        self.previousGuesses.check_to_change_previous_guesses(
            self.guess.value, self.difficulty.random_number)
        ...
        if self.guess.value == self.difficulty.random_number:
            ...
            print("Please input a number between " + str(self.difficulty.min_max[
                  0]) + " and " + str(self.difficulty.min_max[-1]) + ".")
